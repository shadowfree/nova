...
if (!function_exists('wip_before_content_function')) {

	function wip_before_content_function() { 
...
?>
		...
		<div class="line"> 
			...
			<div class="entry-info">
				...
				<?php if  ( ( comments_open() ) && (wip_setting('wip_view_comments') == "on" ) ) : ?>
...
<?php
	...
	add_action( 'wip_before_content', 'wip_before_content_function', 10, 2 );
